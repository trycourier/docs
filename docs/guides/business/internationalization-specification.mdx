...
List blocks can get a bit confusing - [/docs/platform/content/content-blocks/list-blocks/](/docs/platform/content/content-blocks/list-blocks/) an article that can help 🙂
