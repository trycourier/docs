...
How do Segment API calls send notification?
...
The easiest way to successfully link an automation to a segment event is to click “create new” automation” This will create a new automation that uses this Segment event as a trigger, and autopopulates the recipient ID in the send step. All you’ll need to do is select the notification template that should be sent.

Additionally, `refs.data.userid` references data from Segment directly and auto populates the recipient ID in the automation send step (see Automation Send Step figure below).

[Learn more about Courier Automations >](./how-to-automate-message-sequences.mdx)

<Image
  img={require("../../assets/guides/tutorials/segment-auto1.png")}
  alt="Courier - Map Segment Event to Automation"
/>

<Image
  img={require("../../assets/guides/tutorials/segment-auto2.png")}
