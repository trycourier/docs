...
<Image
  img={require("../../assets/twilio-integration.png")}
...
<Image
  img={require("../../assets/twilio-auth-credentials.png")}
...
<Image img={require("../../assets/twilio-phone-number-menu.gif")} alt="Twilio Phone Number Menu" />
...
<Image
  img={require("../../assets/twilio-search-phone-number.gif")}
...
<Image img={require("../../assets/twilio-buy-phone-number.gif")} alt="Buy a Phone Number" />
...
<Image img={require("../../assets/twilio-messaging-service.png")} alt="Twilio Messaging Services" />
...
<Image
  img={require("../../assets/twilio-configure-messaging-service.gif")}
...
<Image img={require("../../assets/twilio-service-sid.png")} alt="Twilio Service SID" />
...
<Image
  img={require("../../assets/twilio-add-number.gif")}
...
<Image
  img={require("../../assets/twilio-courier-notification-template.png")}
...
<Image
  img={require("../../assets/twilio-courier-notification-template-sample.png")}
...
<Image img={require("../../assets/twilio-send-curl-request.png")} alt="Send the cURL Request" />

<Image img={require("../../assets/twilio-delivered-message.png")} alt="Delivered SMS Message" />
