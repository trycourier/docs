...
2. [Create a Courier Notification ](sendgrid#send-a-message)
3. [Send a message with cURL](sendgrid#building-the-curl-request)
...
<Image
  img={require("../../assets/aws-ses-add-user-success.png")}
...
<Image img={require("../../assets/aws-ses-courier.png")} alt="Courier AWS SES integration page" />
...
<Image
  img={require("../../assets/aws-ses-create-identity.png")}
...
<Image
  img={require("../../assets/aws-ses-from-address.png")}
...
<Image img={require("../../assets/aws-ses-region.png")} alt="Region dropdown menu" />

## Create and Send a Courier Notification with AWS SES

See ["Create and Send a Message"](https://dash.readme.com/project/trycourier/v1.2/docs/send-a-message) for details on how to:

- [Build your notification template](https://docs.courier.com/docs/send-a-message) and
- [Send a message with the Courier API using cURL ](https://docs.courier.com/docs/send-a-message#send-a-message)

See the [AWS SES integration doc ](https://docs.courier.com/docs/aws-ses)for profile requirements and override options when sending.
