...
<Image
  img={require("../../assets/courier-notification-template.png")}
...
<Image
  img={require("../../assets/courier-notification-template-sample.png")}
...
<Image
  img={require("../../assets/courier-auth-credentials.png")}
...
<Image img={require("../../assets/send-curl-request.png")} alt="Send the cURL Request" />

<Image img={require("../../assets/delivered-email.png")} alt="Delivered Email" />
