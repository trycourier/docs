...
<div className="platform-list">
  ...
  <div className="platform-item">
    <div className="platform-name">
      <a href="/platform/content">Content</a>
    </div>
    <div className="platform-desc">
      Constructing the content of the notification, including the use of templates, dynamic
      variables and channel agnostic markup.
    </div>
  </div>
  <div className="platform-item">
    <div className="platform-name">
      <a href="/platform/channels">Channels</a>
    </div>
    <div className="platform-desc">
  ...
  <div className="platform-item">
    <div className="platform-name">
      <a href="/platform/sending">Sending</a>
    </div>
    <div className="platform-desc">
  ...
  <div className="platform-item">
    <div className="platform-name">
      <a href="/platform/preferences">Preferences</a>
    </div>
    <div className="platform-desc">
  ...
  <div className="platform-item">
    <div className="platform-name">
      <a href="/platform/automations">Automations</a>
    </div>
    <div className="platform-desc">
      Create fully managed notification workflows and implements scheduling, batching and throttling
      with zero lines of code.
    </div>
  </div>
  <div className="platform-item">
    <div className="platform-name">
      <a href="/platform/inbox">Inbox</a>
    </div>
    <div className="platform-desc">
  ...
  <div className="platform-item">
    <div className="platform-name">
      <a href="/platform/workspaces">Workspaces</a>
    </div>
    <div className="platform-desc">
      Setup test and production environments, manage access control and configure the behavior of
      your apps.
    </div>
  </div>
  <div className="platform-item">
    <div className="platform-name">
      <a href="/platform/logging">Logging</a>
    </div>
