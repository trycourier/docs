...
import { welcomeCardData, platformCardData } from "../version-2.0.0/api-specs/data/intro";

# Welcome to the Courier Docs

Find all the tutorials and resources you need to build product notifications with Courier.

<CardList size="medium" cardData={welcomeCardData} />
...
<CardList size="small" cardData={platformCardData} />
