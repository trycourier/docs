...
- [Setup Email using SendGrid](./platform/channels/email/sendgrid.mdx)
- [Setup SMS using Twilio](./platform/channels/sms/twilio.mdx)
- [Setup Chat using Slack](./platform/channels/direct-message/slack.mdx)
...
[Learn](./platform/channels/intro.mdx) what is needed to integrate with the many supported channel providers.
