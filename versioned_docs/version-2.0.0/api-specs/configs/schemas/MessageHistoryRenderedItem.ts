...
const MessageHistoryRenderedItem: ApiParam = {
  ...
  fields: [
    ...
    },
    {
      ...
      description:
        "A UTC timestamp at which the message was rendered. This is stored as a millisecond representation of the Unix epoch (the time passed since January 1, 1970).",
    },
    {
      type: "string",
      name: "type",
