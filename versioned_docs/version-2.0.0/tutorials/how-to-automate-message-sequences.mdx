...
- Automations can be defined and triggered ad-hoc with a single API call or by calling a re-usable Automation template defined in the [automations visual designer](/docs/platform/automations/designer/).
...
An automation template is a re-usable, pre-defined list of automation steps created in the [automation design studio](/docs/platform/automations/designer/).
...
This automation definition can be saved as an [automation template](/docs/platform/automations/designer/#h_f980e712e4) and scheduled to be invoked on any recurring interval or once on a specific date.
