...
- Automations can be defined and triggered ad-hoc with a single API call or by calling a re-usable Automation template defined in the [automations visual designer](../platform/automations/designer.mdx).
...
An automation template is a re-usable, pre-defined list of automation steps created in the [automation design studio](../platform/automations/designer.mdx).
...
You can follow Courier's Segment [integration guide here](../external-integrations/cdp/segment/segment-integration.mdx).
...
<Image
  img={require("../assets/tutorials/segment-event-trigger.png")}
...
<Image
  img={require("../assets/tutorials/track-event-exact-match.png")}
...
This automation definition can be saved as an [automation template](../platform/automations/designer.mdx) and scheduled to be invoked on any recurring interval or once on a specific date.
...
<Image
  img={require("../assets/tutorials/example-notification-weekly-progress.png")}
  alt="Recipient digest notification template example."
/>

<Image
  img={require("../assets/tutorials/example-notification-weekly-progress-preview.png")}
