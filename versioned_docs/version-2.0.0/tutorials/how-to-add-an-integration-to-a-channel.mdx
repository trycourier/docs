---
description: Learn how to configure your Courier account to send SMS, email other kinds of messages.
...
# How To Add A Provider To A Channel

A step-by-step guide integrating and to adding a provider to a Courier notification channel.

Every notification channel needs an integration before it can send. Multiple channels, and multiple providers within a channel, can be added and managed with a single template. This can be changed at any time.

If you've already configured an Integration for the Channel type(s) in your Notification you'll be able to add them with a single click. If you haven't already completed an Integration for the Channel type, you will need to configure one.
...
<Image
  img={require("../assets/tutorials/inline-channel-settings.png")}
...
<Image
  img={require("../assets/tutorials/channel-settings-dialog.png")}
...
![Adding a configured email provider in the channel settings.](../assets/tutorials/adding-configured-integrations.gif)
...
![Configuring a new Integration in the channel settings.](../assets/tutorials/configuring-an-integration.gif)
...
<Image
  img={require("../assets/tutorials/inline-channel-provider-logo.png")}
...
<Image
  img={require("../assets/tutorials/add-notification-channels.png")}
...
<Image
  img={require("../assets/tutorials/inline-channel-multiple-providers.png")}
...
<Image
  img={require("../assets/tutorials/integrations-tab-icon.png")}
  alt="The integrations tab icon in the left-hand navigation bar."
/>
...
<Image
  img={require("../assets/tutorials/integration-provider-settings.png")}
