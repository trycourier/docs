...
- Name
- Logo ([dimensions and requirements](/docs/platform/content/brands/how-to-use-brands-to-customize/#logo-dimensions-and-file-size-limits)).
...
You can customize the `<style>` element in the `<head>` section of your Brands using custom templates as well as brands built using the Designer UI. Read more about Courier's [CSS Classnames](/docs/platform/content/brands/css-classnames/).
