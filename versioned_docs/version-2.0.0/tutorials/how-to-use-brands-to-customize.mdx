...
- Name
- Logo ([dimensions and requirements](../platform/content/brands/brands-in-email-notifications.mdx)).
...
**Watch:** [Courier live: building and sending white-label emails via the Brands API.](https://help.courier.com/en/articles/4313169-courier-live-branding-and-white-labeling-email-notifications)
