...
<Image img={require("../assets/tutorials/notification-send-tab.png")} alt="Your Product Notification Template" />
...
<Image img={require("../assets/tutorials/automation-design.png")} alt="Setting Up Your Automations Triggers" />