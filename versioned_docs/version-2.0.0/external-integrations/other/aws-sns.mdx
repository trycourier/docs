...
slug: /platform/channels/other/aws-sns
---
...
<Image img={require("../../assets/platform/channels/push-channel.png")} alt="" />

<Image img={require("../../assets/platform/channels/push-channel-settings.png")} alt="" />

2. **Add AWS SNS as a provider:** Click "Add Channel" and use the search bar to find "AWS SNS"

<Image img={require("../../assets/platform/channels/aws-sns-integration.png")} alt="" />
