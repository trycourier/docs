...
You will need to connect Courier as a destination within Segment. At this stage, you will see your segment event table empty and waiting for events.

<Image
  img={require("../assets/external-integrations/segment/segment-no-events.png")}
  alt="Courier - Segment"
/>
...
![Segment Courier Destination Setup](../assets/external-integrations/segment/segment-destination-setup.gif)
...
<Image
  img={require("../assets/external-integrations/segment/segment-test-event.png")}
...
<Image
  img={require("../assets/external-integrations/segment/segment-event-received.png")}
...
<Image
  img={require("../assets/external-integrations/segment/segment-modal.png")}
  alt="Courier - Map Segment Event to Automation"
/>

<Image
  img={require("../assets/external-integrations/segment/segment-new-automation.png")}
  alt="Courier - Automation Send Step"
/>

### Courier as a Segment Source

You can also configure Courier to send events to your segment integration. This allows you to track Courier events in segment.

<GifWrapper width={952} height={500} caption="Add Couier as Segment Sourcep">

![Add Couier as Segment Source](../assets/external-integrations/segment/segment-courier-add-source.gif)

</GifWrapper>

<GifWrapper width={1920} height={1080} caption="Add Segment Write Key">

![Add Segment Write Key](../assets/external-integrations/segment/segment-courier-source-setup.gif)
...
5. _Click away from the input field_ to save and the value will be masked like below.

<Image
  img={require("../assets/external-integrations/segment/segment-write-key.png")}
...
<Image
  img={require("../assets/external-integrations/segment/segment-courier-events.png")}
...
<Image
  img={require("../assets/external-integrations/segment/segment-events-from-courier.png")}
...
<Image
  img={require("../assets/external-integrations/segment/segment-courier-events-configured.png")}
...
In Courier Studio Segment Integration page click the edit/pencil button next to the Write key input, delete the write key and _click away from the input field_.

<Image
  img={require("../assets/external-integrations/segment/segment-edit-write-key.png")}
