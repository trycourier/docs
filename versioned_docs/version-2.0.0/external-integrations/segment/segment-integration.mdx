...
Events flowing in from Segment into Courier are visible on [Segment integration page](https://app.courier.com/channels/segment) inside Courier Studio, from where you can map it to trigger notification workflows. For instance, you can trigger an automation that welcomes a new user if an `analytics.identify` event flows in from Segment.
...
![Segment Courier Destination Setup](../../assets/tutorials/segment-destination-setup.gif)
...
<Image
  img={require("../../assets/tutorials/segment-test-event.png")}
...
<Image
  img={require("../../assets/tutorials/segment-event-received.png")}
