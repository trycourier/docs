...
<!-- Link follow-up doc -->
To programmatically set the From: address on an email template, you'll use a variable in the email channel settings as detailed in this help article: [Setting the 'From', 'Reply-To', 'CC' and 'BCC' Names and Address Fields](https://help.courier.com/en/articles/4745504-setting-the-from-reply-to-cc-and-bcc-names-and-address-fields).