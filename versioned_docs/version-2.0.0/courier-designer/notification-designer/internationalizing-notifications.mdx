...
In this model (one channel per language), the logic defining which notification to fire lives in Courier under the channel settings as [send conditions](https://help.courier.com/en/articles/4323960-using-send-conditions).
<!-- Link follow-up doc -->
...
- [Channel-level conditionals](https://help.courier.com/en/articles/4323960-using-send-conditions) <!-- Link follow-up doc -->
