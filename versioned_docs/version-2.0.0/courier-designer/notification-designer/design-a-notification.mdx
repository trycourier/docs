...
There you have it! A notification with prioritized channels that's ready for a developer to [integrate](/), connect to an [Event](../../reference/events/intro.mdx) and send via the Courier [Send API](../../reference/send/intro.mdx).