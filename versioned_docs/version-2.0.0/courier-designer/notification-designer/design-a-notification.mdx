...
There you have it! A notification with prioritized channels that's ready for a developer to [integrate](/), connect to an [Event](/reference/events) and send via the Courier [Send API](/reference/send).