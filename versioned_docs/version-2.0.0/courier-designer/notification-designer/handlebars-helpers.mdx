...
The `formatMessage` helper can be used to pluralize text in rendered content. Pluralization follows the [ICU format](https://unicode-org.github.io/icu/userguide/format_parse/messages/). Rule entries follow [Unicode CLDR rules](https://cldr.unicode.org/index/cldr-spec/plural-rules).
