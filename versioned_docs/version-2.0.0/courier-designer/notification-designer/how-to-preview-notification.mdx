...
**Read More:** [JSON Paths](https://help.courier.com/en/articles/4339703-json-paths-and-variables-basics) and [Using Substitution Variables](https://help.courier.com/en/articles/4260757-using-variables-to-insert-data-into-a-notification) in your Notifications.
<!-- Link follow-up doc -->
<Image
...
When previewing an Email, if you have created multiple [Brand Templates](../brands/how-to-use-brands-to-customize.mdx), you can switch between them. If you haven't, then the Email preview will use your [Default Brand design](../brands/customize-default-brand.mdx).
