...
Add new channels to a Notification with a single click then drag them to reorder their [send priority](../../sending-notifications/channel-priority.mdx).
...
- Create Test Events to validate your [JSON Paths](https://help.courier.com/en/articles/4339703-json-paths-and-variables-basics) and [dynamic variables](https://help.courier.com/en/articles/4260757-using-variables-to-insert-data-into-a-notification). <!-- Link follow-up doc -->
...
Access the [notification settings](https://help.courier.com/en/articles/4333977-notification-settings-overview) to set send conditions, configure Brands, view publish history and more. <!-- Link follow-up doc -->
...
Read more about [customizing and using Brands](../brands/how-to-use-brands-to-customize.mdx).
