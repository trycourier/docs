...
In order to send notifications to your Inbox, you need to install the [Courier Provider](https://app.courier.com/channels/courier). Navigate to [app.courier.com](https://app.courier.com/) and click on the Channels page in the left menu to find a list of all notification channels, including the Courier Provider.

Once you've installed it, make note of the `Client Key`, which you will need access to when initializing the SDK.

To add the Inbox component to your app, install the SDK:
- [React SDK](../web/react-sdk/)
- [JavaScript SDK](../web/javascript-sdk/)
- [iOS SDK](../mobile/ios-sdk/)
- [Android SDK](../mobile/android-sdk/)

## Default (No Auth)

On the [Courier Provider](https://app.courier.com/channels/courier) page, you'll notice some authentication options that allow you to secure the notification data that is delivered to the client SDKs.
