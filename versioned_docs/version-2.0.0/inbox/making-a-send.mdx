...
> `data` will be passed through, but requires "data mapping" inside of the template to send to the websocket connection and be retrievable through the GQL query
