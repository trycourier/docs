...
Interfacing with Courier's [Send API](../reference/send/message/) for Inbox can be done 2 ways. 
...
The simplest way to send an Inbox message is to use our inline [Elemental](../elemental/) syntax.  This allows you to send a message without having to interact with our [Studio](https://app.courier.com).
