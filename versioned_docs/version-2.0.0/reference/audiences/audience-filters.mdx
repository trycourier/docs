...
- `IS_BEFORE` (checks if specified attribute is before given value, e.g. user's last_login is before 2021-01-01)
...
- `IS_AFTER` (checks if specified attribute is after given value, e.g. user's last_login is after 2021-01-01)
