...
- There is no rate limit on requests made to the [Preferences API](preferences/intro.mdx).

### Messages API

> Not rate limited

- There is no rate limit on requests made to the [Messages API](messages/intro.mdx). 
