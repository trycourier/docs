...
- If your send requests occur at a rate that exceeds your provider's rate limit, Courier's Send pipeline will retry your message for 72 hours following these [send retry rules](../platform/sending/delivery-pipeline-resilience.mdx).
...
- **Subscription Topics:** 20 creations per minute
