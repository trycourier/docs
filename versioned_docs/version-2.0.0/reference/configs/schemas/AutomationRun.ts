  ...
  fields: [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          description: "A unique id or accessor that can be used to cancel this automation from executing via from another automation via the Cancel Automation step.",
          options: [
            {
              type: "string",
              displayName: "string",
