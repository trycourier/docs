        ...
        "override": {
          "body": {
            "notification": {
              ...
              "body": "great match!",
              "image": "https://www.my-image.com/image.png"
            }
          }
        }
      }
...
Everything inside of `providers.firebase-fcm.override.body` will be merged into the [Message object](https://firebase.google.com/docs/reference/fcm/rest/v1/projects.messages#Message) we send to the Firebase FCM API.
