...
When you are ready, return to the Courier Mailgun configuration screen. Flip the toggle switch labelled "Enable polling for status updates" into the off position. Then, press the Save button at the bottom of the screen.
