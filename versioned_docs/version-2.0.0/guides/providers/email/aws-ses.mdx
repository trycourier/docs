...
2. [Create a Courier Notification ](../../../getting-started/send-message/#create-a-notification)
3. [Send a message with cURL](../../../getting-started/send-message/#send-a-message)
...
See ["Create and Send a Message"](../../../getting-started/send-message) for details on how to:

- [Build your notification template](../../../getting-started/send-message/#create-a-notification) and
- [Send a message with the Courier API using cURL](../../../getting-started/send-message/#send-a-message)
