...
<TOCInline toc={toc.slice(1, 0)} maxHeadingLevel={2} />
...
<Image
  img={require("../../../assets/guides/providers/template-import.png")}
...
<Image
  img={require("../../../assets/guides/providers/sg-api-permissions.png")}
