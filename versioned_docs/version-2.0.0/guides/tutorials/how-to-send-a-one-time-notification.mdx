...
You can preview a list of Chat providers we provide [here](https://www.courier.com/docs/guides/providers/direct-message/). Select whichever provider interests you, and configure it. 
...
Here's a [comprehensive guide](https://www.courier.com/docs/courier-designer/using-variables/inserting-variables/.) on how to use variables within your notifications.
