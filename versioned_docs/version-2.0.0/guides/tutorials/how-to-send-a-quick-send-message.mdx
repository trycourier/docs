...
# Introducing Quick Send 2.0

## What is Quick Send?

Quick Send is a product feature that enables a one time send to be crafted and sent to your users in under 5 minutes.

Quick Send is intended to send off messages through one channel and one channel only. If you need to update your users quickly with a notification, Quick Send is the tool for you. 
...
Your default brand will only be present within Quick Send. Ensure that you have a **default branding option** selected, this option will show up within Quick Send for you automatically. To change your branding default settings, visit https://app.courier.com/designer/brands. 

Once you’ve created the branding that you’d like to view within Quick Send, then hit the gear icon on the top left to visit the settings module in order to make it your default branding.
...
These changes will be reflected within Quick Send. 
...
If you’re choosing to send to users via Email or SMS, you can directly write the recipient’s email address or phone number (with area code included) right into the “To:” section of Quick Send and 
...
will be visible through Quick Send. Simply search for your recipient and you will see them appear in the dropdown of options.

### How can I start sending Slack and/or Teams messages?

Both Slack and Teams are providers that connect to the Courier app within the 'Chat' channel. In order to start sending Quick  Send messages through Slack and/or Teams, both providers must 
...
will see your configuration appear within Quick Send. 


### How do I preview a message?

Crafting and previewing a message is synchronous within Quick Send 2.0. We’ve completely gotten rid of the preview as the message that you craft is what the user will evidently see. Give this a try, 
