...
<Image
  img={require("../../assets/guides/courier-app/create-brand.gif")}
  alt="New Brand Modal"
/>
...
* Name
* Logo ([dimensions and requirements](https://help.courier.com/en/articles/4260756-logo-dimensions-for-email-templates)).
...
You can customize the `<style>` element in the `<head>` section of your Brands using custom templates as well as brands built using the Designer UI. Read more about Courier's [CSS Classnames](https://help.courier.com/en/articles/4221118-css-classnames-for-brand-email-templates).
...
<Image
  img={require("../../assets/guides/courier-app/brand-snippet.png")}
  alt="Brand Snippet"
/>
