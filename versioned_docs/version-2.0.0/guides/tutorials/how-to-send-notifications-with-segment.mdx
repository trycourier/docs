...
<GifWrapper width={1920} height={1080} caption="Segment Courier Destination Setup">
...
<GifWrapper width={1920} height={1080} caption="Add Couier as Segment Sourcep">

![Add Couier as Segment Source](../../assets/guides/tutorials/segment-courier-add-source.gif)

</GifWrapper>

<GifWrapper width={1920} height={1080}} caption="Add Segment Write Key">

![Add Segment Write Key](../../assets/guides/tutorials/segment-courier-source-setup.gif)
