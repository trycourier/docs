...
<Image
  img={require("../../assets/guides/tutorials/segment-destination-setup.gif")}
  alt="Segment Courier Destination Setup"
/>
...
<Image
  img={require("../../assets/guides/tutorials/segment-courier-add-source.gif")}
  alt="Add Couier as Segment Source"
/>

<Image
  img={require("../../assets/guides/tutorials/segment-courier-source-setup.gif")}
  alt="Add Segment Write Key"
/>
