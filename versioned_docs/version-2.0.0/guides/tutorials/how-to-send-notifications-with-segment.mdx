...
1. In Segment, navigate to the Sources page (under “Connections”) (https://app.segment.com/[your-workspace-name]/sources)
...
Remove the write key from the Segment Integration page in the Courier Studio and *click away*.