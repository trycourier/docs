...
You can download the following dashboard JSON and import the Courier dashboard into your Datadog account to start getting the observability of Courier into Datadog. 
