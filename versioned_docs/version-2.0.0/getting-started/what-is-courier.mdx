...
If you send notifications to users via [email](../../platform/channels/email/), push, [SMS](../../platform/channels/sms/), or [direct message](../../platform/channels/direct-message/), you can use Courier to:
...
- [Email](../../platform/channels/email/) integrations
- [Push](../../platform/channels/push/) integrations
- [SMS](../../platform/channels/sms/) integrations
- [Direct message](../../platform/channels/direct-message/) integrations
