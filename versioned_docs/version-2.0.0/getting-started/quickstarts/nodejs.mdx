...
3. [Add the channel(s)](https://app.courier.com/channels) you wish t o send your message to.
4. Run `npm install @trycourier/courier` to install the [Node.js SDK](https://github.com/trycourier/courier-node).
5. In the Courier app, get your [API key](https://app.courier.com/settings/api-keys) for either Test or Prod environments
