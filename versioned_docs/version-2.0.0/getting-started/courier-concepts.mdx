...
An event is a unique identifier that can be mapped to an individual Notification. These events can be defined by you, i.e. `new-user` or by an incoming [event through Segment](../external-integrations/segment.mdx).
