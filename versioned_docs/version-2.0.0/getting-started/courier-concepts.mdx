...
The [Conditions](../platform/sending/channel-settings.mdx#conditions) tab in the [Notification](https://help.courier.com/en/articles/4333977-notification-settings-overview), [Channel](../platform/sending/channel-settings.mdx) or [Block](https://help.courier.com/en/articles/4193090-content-block-basics) settings lets you apply conditionals to define when to send a notification, which channel the notification is routed to (even which integration) and which blocks to include.
