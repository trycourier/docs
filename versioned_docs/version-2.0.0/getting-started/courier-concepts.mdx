...
[Content blocks](../platform/content/notification-designer/notification-designer-overview.mdx/#reusable-drag-and-drop-content) are pieces of content that you add to your notification in Couriers drag and drop [Notification Designer](../platform/content/notification-designer/notification-designer-overview.mdx). Content blocks are responsive and reusable across channels.

## Conditions

The [Conditions](../platform/sending/channel-settings.mdx#conditions) tab in the [Notification](../platform/content/notification-settings/general-settings.mdx), [Channel](../platform/sending/channel-settings.mdx) or [Block](../platform/content/content-blocks/content-block-basics.mdx#block-settings) settings lets you apply conditionals to define when to send a notification, which channel the notification is routed to (even which integration) and which blocks to include.
