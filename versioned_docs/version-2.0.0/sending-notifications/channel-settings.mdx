...
- For a more advanced approach, you can use [replacement variables](https://help.courier.com/en/articles/4260757-using-variables-to-insert-data-into-a-notification) in these fields to customize the addresses.
<!-- Link follow-up doc -->
<Image
...
**Read more:** [Using Send Conditions](https://help.courier.com/en/articles/4323960-using-send-conditions).
<!-- Link follow-up doc -->
