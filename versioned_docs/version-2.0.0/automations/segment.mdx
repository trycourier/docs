...
import settingUpDelayAndSend from "./assets/setting-up-delay-and-send.mp4";
import settingUpCancellat from "./assets/setting-up-cancellation-token.mp4";
...
<video width="783" loop autoplay muted controls>
  <source src={segmentTrackVisited2URL} />
</video>
