...
| **Category Key** | (Optional) Defines the key the batch data will be attached to on the data object. See [Working with Multiple Categories](./#working-with-multiple-categories) for more details.                                                                                                                                                                      |
...
instead: `refs.data.<category_key>`.
