...
<Image img={require("../assets/guides/data-logs/logs-navbar.png")} alt="Courier Message Logs" />
...
<Image img={require("../assets/guides/data-logs/logs-overview.png")} alt="Message Logs Tab" />
...
<Image img={require("../assets/guides/data-logs/logs-glance.png")} alt="Message Logs Overview" />

### Send Status Key and Definitions

Each step in the Send status has a visual representation.

<Image img={require("../assets/guides/data-logs/logs-status-keys.png")} alt="Status Keys" />
...
- **Clicked:** user clicked a link in the notification. (This is only available for certain channel providers and only after you enable [click tracking in Courier settings](../getting-started/workspace-settings/track-email-opens.mdx)).
...
<Image img={require("../assets/guides/data-logs/logs-detailed.png")} alt="Detailed View" />
...
<Image img={require("../assets/guides/data-logs/logs-error.png")} alt="Error Tab" />
...
<Image img={require("../assets/guides/data-logs/logs-date.png")} alt="Date Filter" />
...
<Image img={require("../assets/guides/data-logs/logs-status.png")} alt="Status Filter" />

### Error Status Filter

You can also identify notifications with any status that also have errors.

<Image img={require("../assets/guides/data-logs/logs-filter-error.png")} alt="Error Filter" />

### Provider Filter

You can review the logs of any combination of your [integrated providers](../guides/providers/intro.mdx) by selecting them in the `Provider` filter.
...
<Image img={require("../assets/guides/data-logs/logs-automation.png")} alt="Automation Logs" />
