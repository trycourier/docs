...
> The Courier [Messages API](../reference/messages/history-by-id.mdx) lets you get the rendered output of any Courier notification in your send history using the history endpoint.
...
Message history can be fetched by calling the history [endpoint](../reference/messages/history-by-id.mdx) or by calling the getMessageHistory function in our SDKs.
