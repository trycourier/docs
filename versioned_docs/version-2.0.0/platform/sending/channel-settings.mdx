...
- For a more advanced approach, you can use [replacement variables](/docs/platform/content/using-variables/inserting-variables/) in these fields to customize the addresses.
  <!-- Link follow-up doc -->
  <Image
...
**Read more:** [Using Send Conditions](/docs/platform/content/notification-settings/send-conditions/).
