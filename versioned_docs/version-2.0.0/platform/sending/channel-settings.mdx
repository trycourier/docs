...
- For a more advanced approach, you can use [replacement variables](../content/using-variables/inserting-variables.mdx) in these fields to customize the addresses.
  <!-- Link follow-up doc -->
  <Image
