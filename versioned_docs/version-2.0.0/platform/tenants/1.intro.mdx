...
You can set a Tenant's Default Preferences for [Subscription Topics](../preferences/preference-center/designer/#subscription-topics) by providing the topics you want to override. For example if your Product Notifications (id: 72YE3TJK7S40KWN427Y69FD4D4FH) should be defaulted OPTED_IN for one tenant.
