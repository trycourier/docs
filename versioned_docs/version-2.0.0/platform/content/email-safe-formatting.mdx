...
Use inline CSS styles rather than external or internal stylesheets. This ensures that your styling is more likely to be rendered consistently across various email clients. Additionally, you can leverage the [brands designer](../brands/brands-in-email-notifications) to apply CSS styles to your email templates.
