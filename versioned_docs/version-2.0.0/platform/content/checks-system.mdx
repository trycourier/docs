...
[Internationalization Specification](./internationalization-specification.mdx) has an example on how custom check can be leveraged for template translations workflow.
