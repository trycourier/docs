...
- Profile data either sent as part of the send command [profile object](../variables/inserting-variables.mdx#the-user-profile) or stored in Courier as part of a recipient [profile](/reference/profiles/intro.mdx)
