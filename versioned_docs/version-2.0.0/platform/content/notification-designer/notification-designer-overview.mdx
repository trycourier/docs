...
- Create Test Events to validate your [JSON Paths](/docs/platform/content/using-variables/inserting-variables/#the-user-profile-basics) and [dynamic variables](/docs/platform/content/using-variables/inserting-variables/). <!-- Link follow-up doc -->
...
Access the [notification settings](/docs/platform/content/notification-settings/general-settings/) to set send conditions, configure Brands, view publish history and more. <!-- Link follow-up doc -->
