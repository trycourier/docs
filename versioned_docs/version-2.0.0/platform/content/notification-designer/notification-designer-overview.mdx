...
- Create Test Events to validate your [JSON Paths](/docs/platform/content/using-variables/json-paths-variables/) and [dynamic variables](/docs/platform/content/using-variables/inserting-variables/). <!-- Link follow-up doc -->
