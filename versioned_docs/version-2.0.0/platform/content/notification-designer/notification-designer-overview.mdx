...
- Create Test Events to validate your [JSON Paths](../using-variables/json-paths-variables.mdx) and [dynamic variables](../using-variables/inserting-variables.mdx). <!-- Link follow-up doc -->
