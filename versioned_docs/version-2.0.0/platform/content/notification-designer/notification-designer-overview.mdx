...
- Create Test Events to validate your [JSON Paths](../variables/json-paths-variables.mdx) and [dynamic variables](../variables/inserting-variables.mdx). <!-- Link follow-up doc -->
