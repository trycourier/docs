...
- Create Test Events to validate your [JSON Paths](../using-variables/json-paths-variables.mdx) and [dynamic variables](/docs/platform/content/using-variables/inserting-variables/). <!-- Link follow-up doc -->
...
Access the [notification settings](../notification-settings/general-settings.mdx) to set send conditions, configure Brands, view publish history and more. <!-- Link follow-up doc -->
