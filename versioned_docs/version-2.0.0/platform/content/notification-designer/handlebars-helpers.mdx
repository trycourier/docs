...
Use the variable handler to resolve a `JSONPath`, and returns the resolved value. Returns undefined if the value was not found. Similar to [var](#var).
...
Uses the variable handler to resolve a `JSONPath`, and returns the resolved value. Returns undefined if the value was not found. Similar to [path](#path).
