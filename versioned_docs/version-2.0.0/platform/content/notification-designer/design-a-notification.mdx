...
Click to open a channel and begin creating content. Use the content toolbar to add [content blocks](/docs/platform/content/content-blocks/content-block-basics/) and customize the content within them. These blocks are reusable across channels - so you only have to build your content once.
