...
[Channel and Integration send priority](../../../platform/sending/channel-priority.mdx) is set on a per-notification basis. There are two levels of priority you can set for channels: **Best of** and **Always**.
...
- Best of is defined as the first channel where the Profile data is complete (as defined in the [integration docs](/platform/channels) for that provider)
...
**Read more:** [Setting send priority rules for channels and integration.](../../../platform/sending/channel-priority.mdx)
