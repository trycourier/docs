...
**Read More:** [JSON Paths](../variables/json-paths-variables.mdx) and [Using Substitution Variables](../variables/inserting-variables.mdx) in your Notifications.
{/* Link follow-up doc */}
<Image
...
When previewing an Email, if you have created multiple [Brand Templates](../../brands/brands-in-email-notifications/#customize-your-brands), you can switch between them. If you haven't, then the Email preview will use your [Default Brand design](../../brands/brands-in-email-notifications/#the-default-brand).
