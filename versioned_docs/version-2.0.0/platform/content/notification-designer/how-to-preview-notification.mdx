...
When previewing an Email, if you have created multiple [Brand Templates](../../brands/brands-in-email-notifications/#customizing-brands), you can switch between them. If you haven't, then the Email preview will use your [Default Brand design](../../brands/brands-in-email-notifications/#the-default-brand).
