...
When previewing an Email, if you have created multiple [Brand Templates](../brands/how-to-use-brands-to-customize.mdx/#customize-your-brands), you can switch between them. If you haven't, then the Email preview will use your [Default Brand design](../brands/customize-default-brand.mdx).
