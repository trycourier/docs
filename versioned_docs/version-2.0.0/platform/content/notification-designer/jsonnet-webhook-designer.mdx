...
To deliver an HTTP request, Courier must be provided with a destination. For details on how to set up a dynamic destination, see the [Webhook integration developer documentation](/platform/channels/other/webhook-integration).
