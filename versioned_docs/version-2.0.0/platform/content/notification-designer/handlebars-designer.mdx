...
If you need to use Handlebars for a portion of your email, use [template blocks](/docs/platform/content/content-blocks/template-blocks/) and combine them with other [block types](/docs/platform/content/notification-designer/notification-designer-overview/#reusable-drag-and-drop-content) to allow your non-handlebars code content to be re-used in other channels.
