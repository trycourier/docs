...
- [Filters](/docs/platform/content/notification-designer/notification-designer-overview/#reusable-drag-and-drop-content) to hide or show blocks.
- [Repeatable List Blocks](/docs/platform/content/content-blocks/list-blocks/) to set the list scope.
- [Substitution Variables](/docs/platform/content/using-variables/inserting-variables/#data-sources-for-substitution-variables) to insert values into Notifications.
...
If you want to access properties from the associated account object created with the [Accounts API](../../../reference/accounts/intro.mdx), use a full JSONPath expression such as `$.account.company_name`.
