...
The standard or brand type lets you edit the Head to define your own custom styles. In addition to the normal CSS class names, you can define the CSS for Courier blocks using [Courier's CSS classnames](css-classnames.mdx).

<Image
  img={require("../../../assets/guides/courier-app/brand-inherit-head.png")}
  alt="Brand Head"
/>
...
<Image
  img={require("../../../assets/guides/courier-app/brand-default-badge.png")}
  alt="Brand Default Badge"
/>
...
1. Open your default brand and create a [brand snippet](brand-snippets.mdx) to contain your reusable CSS styling. You can define the CSS for Courier blocks using [Courier's CSS classnames](css-classnames.mdx).
...
2. Open your default brand or create a brand in the Courier designer and select one of the Custom Template types:
  - MJML/Handle bars 
  - Handle bars
3. To pull the CSS from your default brand CSS brand snippet into any other brand, insert the css brand snippet variable inside the style tags:

<Image
  img={require("../../../assets/guides/courier-app/brand-style-snippet.png")}
  alt="CSS Style Snippet"
/>
