...
The rendered output of the list block is a table element. The list block does not currently support an output of bulleted lists. For more list customization, you can use a [template block](template-blocks.mdx) with [helpers](../notification-designer/handlebars-helpers.mdx).
