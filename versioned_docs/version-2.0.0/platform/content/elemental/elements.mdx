...
| locales  | `string` |          | Region specific content. See [locales](locales.mdx) doc for more details.                    |
...
For more details on using these properties, see the [control flow](control-flow.mdx) docs.