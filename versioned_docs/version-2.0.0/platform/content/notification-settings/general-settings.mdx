...
- Brands are "enabled" by default so each new email notification will use your [Default Brand](../../brands/how-to-use-brands-to-customize/#customize-your-brands) template unless you disable it.
- Brands must be "enabled" to use [Custom Brands](../../brands/how-to-use-brands-to-customize/#send-a-branded-email-notification) on email notifications.
...
- You can enter a comma seperated list of tags and those will automatically be put into the `metadata.tags` [docs](../../../../version-2.0.0/reference/send/message/#the-metadata-property) field when sending to the user. 
- This allows them to be filtered in a view on the inbox using one of those tags or filtered with our [Messages API](../../../../version-2.0.0/reference/messages/list).
