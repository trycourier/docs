...
- You can enter a comma separated list of tags and those will automatically be put into the `metadata.tags` [docs](../../../../reference/send/message/#the-metadata-property) field when sending to the user. 
