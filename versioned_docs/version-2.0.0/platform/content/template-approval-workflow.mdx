...
To see examples of other notification submission event typs, review the [webhook documentation](../../platform/events/outbound-webhooks.mdx/#notificationsubmitted).
