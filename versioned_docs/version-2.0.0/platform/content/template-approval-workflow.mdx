...
To see examples of other notification submission event typs, review the [webhook documentation](../../platform/workspaces/outbound-webhooks.mdx/#notificationsubmitted).
