...
2. [Create a Courier Notification ](../../../../platform/sending/send-message/#create-a-notification)
3. [Send a message with cURL](../../../../platform/sending/send-message/#send-a-message)
...
See ["Create and Send a Message"](../../../../platform/sending/send-message) for details on how to:

- [Build your notification template](../../../../platform/sending/send-message/#create-a-notification) and
- [Send a message with the Courier API using cURL](../../../../platform/sending/send-message/#send-a-message)
