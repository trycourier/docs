...
<Image img={require("./assets/segment-checkout.gif")} alt="Segment Trigger" />
...
<Image img={require("./assets/checkout-visited.png")} alt="UserId Referenced" />
...
<Image img={require("./assets/segment-checkout-complete.gif")} alt="New Automation" />
