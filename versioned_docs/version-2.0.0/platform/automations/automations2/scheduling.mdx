...
Please note that the schedule trigger should be set to the [UTC-0 timezone](https://dayspedia.com/time/zones/utc+0/) and is delayed by 12 minutes. This means that your scedule should be set in **UTC-0 + 12'**.
