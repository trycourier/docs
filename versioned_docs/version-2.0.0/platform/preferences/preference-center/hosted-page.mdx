...
Just like with email templates, the Preference Center can be customized to fit your [branding style](../brands/how-to-use-brands-to-customize.mdx/#customize-your-brands). The Preference Center will use the the specified default brand.
