...
Just like with email templates, the Preference Center can be customized to fit your [branding style](../../content/brands/customize-default-brand.mdx). The Preference Center will use the the specified default brand.
