...
When [creating a new notification](../../content/notification-designer/design-a-notification.mdx), you'll see the option to map it to a subscription topic in the creation modal.
