...
Just like with email templates, the Preference Center can be customized with your [brand](../content/brands/how-to-use-brands-to-customize.mdx/#customize-your-brands). 
