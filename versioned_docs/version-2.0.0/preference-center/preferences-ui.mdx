...
:::caution Preference Center is currently in closed beta
...
<Image
  img={require("../assets/guides/preferences-ui/preferences-preferences-page-free.png")}
...
<Image
  img={require("../assets/guides/preferences-ui/preferences-channel-select.png")}
