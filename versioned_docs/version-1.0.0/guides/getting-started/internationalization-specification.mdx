...
## Updating partial contents (Shipping soon)
...
`PUT /notifications/:notification_id/blocks/:block_id/locales`

or `PUT /notifications/:id/draft/blocks/:blockId/locales`
...
`PUT /notifications/:id/channels/:channelId/locales`

or `PUT /notifications/:id/draft/channels/:channelId/locales`
